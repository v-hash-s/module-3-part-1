...
function createNode(value, tagName, ctx) {
  ...
  if (tagName && tagName.startsWith('!!')) tagName = PlainValue.defaultTagPrefix + tagName.slice(2);
...
const strOptions = {
  ...
  defaultKeyType: PlainValue.Type.PLAIN,
...
function stringifyString(item, ctx, onComment, onChompKeep) {
  ...
  if (type !== PlainValue.Type.QUOTE_DOUBLE) {
    ...
    if (/[\x00-\x08\x0b-\x1f\x7f-\x9f]/.test(value)) type = PlainValue.Type.QUOTE_DOUBLE;
  }
