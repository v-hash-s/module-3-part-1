...
"use strict";
eval("\nObject.defineProperty(exports, \"__esModule\", ({ value: true }));\nexports.signUp = void 0;\nconst logger_1 = __webpack_require__(/*! @helper/logger */ \"./helper/logger.ts\");\nconst sign_up_manager_1 = __webpack_require__(/*! ./sign_up.manager */ \"./api/gallery/signUp/sign_up.manager.ts\");\nconst sign_up_service_1 = __webpack_require__(/*! ./sign_up.service */ \"./api/gallery/signUp/sign_up.service.ts\");\nconst error_handler_1 = __webpack_require__(/*! @helper/http-api/error-handler */ \"./helper/http-api/error-handler.ts\");\nconst response_1 = __webpack_require__(/*! @helper/http-api/response */ \"./helper/http-api/response.ts\");\nconst signUp = async (event) => {\n    console.log(\"EVENT: \");\n    logger_1.log(event);\n    try {\n        const credentials = JSON.parse(event.body);\n        const manager = new sign_up_manager_1.SignUpManager();\n        const service = new sign_up_service_1.SignUpService();\n        const result = await manager.signUp(credentials, service);\n        return response_1.createResponse(result.statusCode, result.message);\n    }\n    catch (error) {\n        return error_handler_1.errorHandler(error);\n    }\n};\nexports.signUp = signUp;\n\n\n//# sourceURL=webpack://template-aws-sls/./api/gallery/signUp/handler.ts?");

/***/ }),

/***/ "./api/gallery/signUp/sign_up.manager.ts":
/*!***********************************************!*\
  !*** ./api/gallery/signUp/sign_up.manager.ts ***!
  \***********************************************/
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
"use strict";
eval("\nObject.defineProperty(exports, \"__esModule\", ({ value: true }));\nexports.SignUpManager = void 0;\nconst sign_up_service_1 = __webpack_require__(/*! ./sign_up.service */ \"./api/gallery/signUp/sign_up.service.ts\");\nconst http_1 = __webpack_require__(/*! @errors/http */ \"./errors/http/index.ts\");\nclass SignUpManager {\n    constructor() {\n        this.service = new sign_up_service_1.SignUpService();\n    }\n    async signUp(credentials, service) {\n        if (!credentials) {\n            throw new http_1.HttpBadRequestError(\"Credentials not provided\");\n        }\n        return await this.service.signUp(credentials);\n    }\n}\nexports.SignUpManager = SignUpManager;\n\n\n//# sourceURL=webpack://template-aws-sls/./api/gallery/signUp/sign_up.manager.ts?");

/***/ }),

/***/ "./api/gallery/signUp/sign_up.service.ts":
/*!***********************************************!*\
  !*** ./api/gallery/signUp/sign_up.service.ts ***!
  \***********************************************/
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
/******/ 	var __webpack_exports__ = __webpack_require__("./api/gallery/signUp/handler.ts");
